...
<html>
    <head>
        ...
        <title>ReadOnlyFeedback | e-channelling</title>
...
<!--search bar-->
   ...
   <c:set var="feedR" value="${CusFeedR}"/> <!--Form read-->
   ...
   <fieldset disabled>
      ...
      <input type="text" id="email" name="email" placeholder="Email"  value="${feedR.email}"><br><br><br>
      
      <label for="name">Name:</label><br>
      <input type="text" id="name" name="first" placeholder="First"  value="${feedR.first}">
      <input type="text" id="name" name="last" placeholder="Last" value="${feedR.last}" ><br><br><br>

      
      <label for="textarea">Feedback:</label><br>
      <input type="text" id="textarea" name="feedbackText"  value="${feedR.feedbackText}"><br><b></b>
      </fieldset>
      
      
        <form action ="FeedbackUpdate.jsp" method="post">
	     <input type="hidden" name="email" value="${feedR.email}">
	     <input type="hidden" name="first" value="${feedR.first}">
	     <input type="hidden" name="last" value="${feedR.last}">
	     <input type="hidden" name="feedbackText" value="${feedR.feedbackText}">
      
      </form>
	 
	  
	 <br><br><form action="readfeedback" method="post" >
	  <button type="submit">All feedback</button>
	  </form>
