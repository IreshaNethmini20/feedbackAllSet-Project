...
<html>
    <head>
        ...
        <title>InsertFeedback | e-channelling</title>
...
<!--search bar-->
   ...
   <div id="fform">
	  <h1>Feedback Form</h1>
    <form action="InsertCustomerFeedback" method="post" class="structure">

      <label for="email">Email:</label><br>
      <input type="text" id="email" name="email" placeholder="Email"  ><br><br><br>
      
      <label for="name">Name:</label><br>
      <input type="text" id="name" name="first" placeholder="First"  >
      <input type="text" id="name" name="last" placeholder="Last"  ><br><br><br>
